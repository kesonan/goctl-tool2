...
const Datasource: React.FC = () => {
  ...
  return (
    <>
      ...
      {contextHolder}
      <Flex className="mysql-datasource" gap={1} wrap>
        <div className={"mysql-datasource-form-container"}>
          <Form.Provider>
            <Flex vertical wrap justify={"space-around"}>
              ...
              >
                <div className={"mysql-datasource-connection-panel"}>
        ...
        >
          ...
          />
          <CodeMirror
            className={"mysql-datasource-editor-container"}
            value={code}
            extensions={[
              langs.go(),
              EditorView.theme({
